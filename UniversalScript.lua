...
local Window = Library.CreateLib("Universal script | by DobixScript YT", "DarkTheme")
local Tab = Window:NewTab("creator")
local Section = Tab:NewSection("credit ui: kavo ui")
local Section = Tab:NewSection("owner: DobixScript")
local Section = Tab:NewSection("script hub: infinite yield, nameless admin")

--home page
local Tab2 = Window:NewTab("home")
local Tab2 = Tab2:NewSection("home page")
Tab2:NewKeybind("keybind open/close ui", "ccustom keybind", Enum.KeyCode.F, function()
	Library:ToggleUI()
end)
Tab2:NewTextBox("chang speed", "speed hack", function(num)
	game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = num
end)
Tab2:NewTextBox("chang jump", "jump hack", function(num)
	game.Players.LocalPlayer.Character.Humanoid.JumpPower = num
end)
Tab2:NewButton("noclip (pc)", "press x button from your keyboard", function()
...
-- Store character parts to avoid repeatedly searching for them
...
local characterParts = updateCharacterParts()
Host.Character.DescendantAdded:Connect(function(descendant)
...
Tab2:NewTextBox("custom hitbox size", "hitbox hack", function(num)
	_G.HeadSize = num
_G.Disabled = true
...
Tab2:NewTextBox("fling player", "enter name player", function(txt)
	local Targets = {txt} -- "All", "Target Name", "r3da09"
...
Tab2:NewButton("fly (pc)", "press e button from key board ", function()
    local flybutton = "e"
local flyspeed = 100
local controls = {
	front = "w",
...
--script hub
local Tab3 = Window:NewTab("script hub")
local Tab3 = Tab3:NewSection("admin script")
Tab3:NewButton("infinite yield", "admin (fe)", function()
    loadstring(game:HttpGet(('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'),true))()
end)
Tab3:NewButton("nameless admin", "admin (fe)", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/FilteringEnabled/NamelessAdmin/main/Source'))()
end)

--ui เปิดฝปิด
local DobixToggle = Instance.new("ScreenGui")
local ImageButton = Instance.new("ImageButton")
local UICorner = Instance.new("UICorner")

--Properties:

DobixToggle.Name = "DobixToggle"
DobixToggle.Parent = game.CoreGui
DobixToggle.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

ImageButton.Parent = DobixToggle
ImageButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
ImageButton.BorderColor3 = Color3.fromRGB(0, 0, 0)
ImageButton.BorderSizePixel = 0
ImageButton.Position = UDim2.new(0.0607638843, 0, 0.460709304, 0)
ImageButton.Size = UDim2.new(0, 68, 0, 66)
ImageButton.Image = "rbxassetid://132102943398257"
